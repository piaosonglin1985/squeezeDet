...
def train():
  ...
  with tf.Graph().as_default():
    ...
    def _load_data(load_to_placeholder=True):
      # read batch input
      image_per_batch, index_per_batch, mag_per_batch, label_per_batch, box_delta_per_batch, aidx_per_batch, \
          bbox_per_batch = imdb.read_batch_with_idx_mag()
      ...
      if load_to_placeholder:
        ...
        index_input = model.ph_index_input
        mag_input = model.ph_mag_input
        ...
        index_input = model.index_input
        mag_input = model.mag_input
      ...
      feed_dict = {
          ...
          index_input: index_per_batch,
          mag_input: mag_per_batch,
